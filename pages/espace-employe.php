...
<section class="dashboard-section">
    <div class="container">
        ...
        <p style="color: var(--color-gray); margin-bottom: 2rem;">Gérez les commandes et modérez les avis clients</p>
        ...
        <!-- Commandes -->
        <h5 class="mb-3" style="color: var(--color-bordeaux);">📦 Commandes (<?= count($commandes) ?>)</h5>
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <h6 style="color: var(--color-bordeaux);"><?= htmlspecialchars($commande['numero_commande']) ?></h6>
        ...
        <!-- Modération avis -->
        <h5 class="mt-5 mb-3" style="color: var(--color-bordeaux);">⭐ Avis en attente de modération (<?= count($avis) ?>)</h5>
        <?php if (empty($avis)): ?>
            <div class="card">
                <div class="card-body text-center">
